								...
								<div class="table-responsive">
									<div class="pickup-slots">
										...
										<label class="time_slot success-light <?= isset($pickup_slots) && in_array($slots['slot_start_time'].' - '.$slots['slot_end_time'],$pickup_slots)==1?"active":"" ;?>">
											...
											<input type="checkbox" class="timeChecked" name="time_slots[]" value="<?= $slots['slot_start_time'] ;?> - <?= $slots['slot_end_time'] ;?>" <?= isset($pickup_slots) && in_array($slots['slot_start_time'].' - '.$slots['slot_end_time'],$pickup_slots)==1?"checked":"" ;?>> <?= $slots['slot_start_time'] ;?> - <?= $slots['slot_end_time'] ;?>
										</label>
