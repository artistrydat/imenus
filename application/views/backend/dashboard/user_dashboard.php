    ...
    <div class="row mb-10">
      <div class="col-md-6 col-md-offset-3">
        <div class="share_able_link">
          <p><?= !empty(lang('profile_link'))?lang('profile_link'):"Profile Link"?>: <span><?= base_url(auth('username')) ;?></span> <a href="javascript:;" class="copy_btn btn-success copy" data-id="<?= auth('id') ;?>" data-link="<?= base_url($this->my_info['username']) ;?>"><?= !empty(lang('copy'))?lang('copy'):"Copy"?></a></p>
