				...
				<div class="user_profile_details text-center mt-20">
					<div class="form-group">
						...
						<?php if(restaurant($auth_info['id'])->is_admin_onsignal==0): ?>
							<a href="<?= base_url("admin/settings/enable_extras/{$auth_info['id']}/is_admin_onsignal/1"); ?>" class="btn btn-secondary" data-toggle="tooltip" title="<?= lang('allow_onsignal_access'); ?>"><i class="icofont-hand-drag1"></i> <?= lang('enable'); ?></a>
						<?php else: ?>
							<a href="<?= base_url("admin/settings/enable_extras/{$auth_info['id']}/is_admin_onsignal/0"); ?>" class="btn btn-primary action_btn" data-toggle="tooltip" title="<?= lang('disabled_onsignal_access'); ?>"><i class="icofont-hand-drag1"></i> <?= lang('disable'); ?></a>
						<?php endif;?>
