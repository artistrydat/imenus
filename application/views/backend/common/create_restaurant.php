			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						<div class="form-group col-sm-6">
							<label  class="control-label"><?= !empty(lang('short_name'))?lang('short_name'):"Short name";?></label>

							<div>
								<input type="text" name="short_name" class="form-control"  placeholder="<?= !empty(lang('short_name'))?lang('short_name'):"Short name";?>" value="<?= !empty($restaurant['short_name'])?$restaurant['short_name']:''; ?>" maxlength="3">
							</div>
						</div>
