							...
							<div class="left_package_details_signup with_package pricing_3" >
								<div class="card mb-5 mb-lg-0 signupCard">
						          <div class="card-body">
						            ...
						            <?php else: ?>
						            	<h6 class="card-price text-center"><?= get_currency('icon');?><?= html_escape($package['price']) ;?><span class="period">/<?= !empty(lang(get_package_type($package['package_type'])))?lang(get_package_type($package['package_type'])):get_package_type($package['package_type']);?></span></h6>
						            <?php endif;?>
						            <hr>
						            <ul class="fa-ul">
