			...
			<div class="righShopDetails">
				...
				<div class="shopBottom">
					<ul>
						...
						<li title="<?= lang('available_time'); ?>" data-toggle="tooltip"><i class="icofont-hour-glass"></i> <?= isset($time['start_time'])?$time['start_time']:0 ;?> - <?= isset($time['end_time'])?$time['end_time']:0 ;?></li>
