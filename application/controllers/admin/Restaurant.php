...
public function add_order_item($uid,$id)
{
	...
	$total_price = grand_total($price_format,$order_info['delivery_charge'],$order_info['discount'],$order_info['tax_fee'],$order_info['coupon_percent'],$order_info['tips'],$order_info['order_type']);
